...
public class DormCleanController {
    ...
    public String updateDormClean(Integer g_id,Integer d_id,String  d_dormbuilding,Integer d_grade,String update_time) {
        DormClean dormclean =new DormClean();
        dormclean.setG_id(g_id);
        dormclean.setD_dormbuilding(d_dormbuilding);
        dormclean.setD_id(d_id);
        dormclean.setUpdate_time(new Date());
        dormclean.setD_grade(d_grade);
